...
**Current: `1e89286e9a9698e4869309fcef0fe6b275512e104ce4e7cae17e28fd8dbe1124`** · **103 paths** ·
**233 schemas** · api version `v1` · moved 2026-09-23 by weekly reports (§6.10).
Previous: `0a74f0192c73…` / 95 paths / 212 schemas, annual computation on 2026-09-22; before that `bb29ee1ebe04…` (pin printing), `5d01b0800150…` (pin batches), `b4bf1cf369f2…` (withdraw/reopen), `d1816d8c15b8…` (publication), `905632799f5c…` (TASK-0005b), `e7113c87a76b…` (TASK-0090), `584a4a3c9d5c…` (TASK-0088), `42d8e3b52ba4…` (TASK-0086), `9c2f8d55fe3a…` (TASK-0083), `8e3087d93f02…` (TASK-0072), `0ebca075110e…` (TASK-0071),
