...
| TASK-0013 | Idempotency — Option B (defer, binding record), decided 2026-09-04 | BE | TASK-0001 blocker B2. §6 requires `Idempotency-Key`; it appears nowhere, undocumented. Spec 9.8.2 needs it by Phase 2. Decide-now, not fix-now. | queued |
