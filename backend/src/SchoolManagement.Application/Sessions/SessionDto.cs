...
/// <summary>
/// The list-item shape of a session (spec 6.3.8). Arms, enrolled-pupil and publication counts are
...
/// <c>0</c>). See TASK-0035's Log for the tracked deferral.
/// </summary>
/// <param name="Id">Opaque identifier.</param>
...
/// <summary>
/// The detail shape of a session (spec 6.3.8, 6.3.10): its own fields plus its three terms. Arms
/// grouped by level, enrolment counts and the publication position are deferred for the same reason
/// as <see cref="SessionDto"/>; the promotion panel is all of TASK-0036.
/// </summary>
/// <param name="Id">Opaque identifier.</param>
/// <param name="Name"><c>YYYY/YYYY</c>.</param>
/// <param name="StartDate">Inside the first named year.</param>
