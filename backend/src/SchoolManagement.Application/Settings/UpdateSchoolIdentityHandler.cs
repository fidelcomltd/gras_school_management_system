    ...
    : IRequestHandler<UpdateSchoolIdentityCommand, Result<SettingsIdentityGroupDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // TASK-0069/TASK-0072 stage 3a: the snapshot carries every group, not only the one this save
        // changed (spec 6.2.9) — this group has no field of its own in SettingsSnapshotState (it lives
        // on SchoolProfile itself), so no override is needed.
